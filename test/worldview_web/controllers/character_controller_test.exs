defmodule WorldviewWeb.CharacterControllerTest do
  ...
  @create_attrs %{agility: 42, archetype: "some archetype", brawn: 42, career: "some career", cunning: 42, intellect: 42, melee_defense: 42, name: "some name", player_name: "some player_name", presence: 42, ranged_defense: 42, soak: 42, strain: 42, strain_threshold: 42, willpower: 42, wound_threshold: 42, wounds: 42}
  @update_attrs %{agility: 43, archetype: "some updated archetype", brawn: 43, career: "some updated career", cunning: 43, intellect: 43, melee_defense: 43, name: "some updated name", player_name: "some updated player_name", presence: 43, ranged_defense: 43, soak: 43, strain: 43, strain_threshold: 43, willpower: 43, wound_threshold: 43, wounds: 43}
  @invalid_attrs %{agility: nil, archetype: nil, brawn: nil, career: nil, cunning: nil, intellect: nil, melee_defense: nil, name: nil, player_name: nil, presence: nil, ranged_defense: nil, soak: nil, strain: nil, strain_threshold: nil, willpower: nil, wound_threshold: nil, wounds: nil}
