defmodule Worldview.CharactersTest do
  ...
  describe "characters" do
    ...
    @valid_attrs %{agility: 42, archetype: "some archetype", brawn: 42, career: "some career", cunning: 42, intellect: 42, melee_defense: 42, name: "some name", player_name: "some player_name", presence: 42, ranged_defense: 42, soak: 42, strain: 42, strain_threshold: 42, willpower: 42, wound_threshold: 42, wounds: 42}
